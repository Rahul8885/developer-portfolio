...
import { FlipWords } from '@/components/ui/container-text-flip';
...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{ y: LayerText }}
        className="absolute z-[40] top-32 md:top-36 w-[90%] lg:w-[55%] left-8 md:left-20  -tracking-tight leading-[1em]"
      >
       
        <h1 className="lg:text-[72px] md:text-[60px] text-[40px] font-bold font-neue leading-[1em] tracking-tight text-accentblue">
        ...
        <h1 className="lg:text-[72px] md:text-[60px] text-[40px] font-bold font-neue leading-[1em] tracking-tight text-accentblue">
          a 
          <span>
            <FlipWords className='font-neue text-darkblue' words={["Full Stack Developer", "Web Designer", "App Developer", "AWS Developer"]}/>
          </span>
        </h1>
